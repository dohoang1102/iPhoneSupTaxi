...
@implementation SupTaxiDataBase
...
static SupTaxiDataBase* instance_;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SupTaxiDataModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SupTaxiDataModel.sqlite"];
...
#pragma mark - my address methods implement
